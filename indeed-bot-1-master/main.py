...
class IndeedBot:
    ...
    def __init__(self):
        ...
        self.driver = webdriver.Chrome('/Users/hvaandres/Downloads/indeed-bot-1-master/chromedriver')
...
if __name__ == '__main__':
    ...
    profile = {
        'name': "Alan Haro",
        'email': "ithvaandres@gmail.com",
        'phone_number': '860-364-3249',
        'resume': os.getcwd() + '/Users/hvaandres/Downloads/indeed-bot-1-master/Alan A. Haro - Resume.pdf'
    }
    
    id_bot = IndeedBot()

    # keywords, city, state
    id_bot.query('python developer', 'salt lake city', 'ut')
